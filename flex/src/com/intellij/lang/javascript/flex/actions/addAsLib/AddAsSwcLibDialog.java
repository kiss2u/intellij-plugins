...
public class AddAsSwcLibDialog extends DialogWrapper {
  ...
  private final FlexBCTree myBCTree;
  private final JBList myLibComponentsList;
  private final JCheckBox myOpenProjectStructureCheckBox;
  ...
  public AddAsSwcLibDialog(final @NotNull Project project, final @Nullable Module preferredModule, final List<VirtualFile> roots) {
    ...
    }
    {
      ...
      myOpenProjectStructureCheckBox = new JCheckBox();
      myOpenProjectStructureCheckBox.setText("Open Project Structure after adding a library");
      myOpenProjectStructureCheckBox.setMnemonic('O');
      myOpenProjectStructureCheckBox.setDisplayedMnemonicIndex(0);
      myMainPanel.add(myOpenProjectStructureCheckBox,
      ...
      myMainPanel.add(jBScrollPane1, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                                         GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                                                         GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
      myLibComponentsList = new JBList();
      jBScrollPane1.setViewportView(myLibComponentsList);
      final JBLabel jBLabel1 = new JBLabel();
      jBLabel1.setText("Library contents:");
      ...
      myMainPanel.add(jBScrollPane2, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH,
                                                         GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW,
                                                         GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null,
                                                         null, null, 0, false));
      jBScrollPane2.setViewportView(myBCTree);
    }
  ...
  protected void doOKAction() {
    ...
    final LibraryTable.ModifiableModel projectLibsModel =
      LibraryTablesRegistrar.getInstance().getLibraryTable(myProject).getModifiableModel();

    final LibraryTable.ModifiableModel globalLibsModel =
      LibraryTablesRegistrar.getInstance().getGlobalLibraryTable(myProject).getModifiableModel();
