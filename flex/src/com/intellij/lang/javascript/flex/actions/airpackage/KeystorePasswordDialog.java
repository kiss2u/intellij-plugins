...
public class KeystorePasswordDialog extends DialogWrapper {
  ...
  private final JCheckBox myRememberPasswordsCheckBox;
  ...
  public KeystorePasswordDialog(final Project project, final Collection<AirSigningOptions> signingOptionsWithUnknownPasswords) {
    ...
    myProject = project;
    {
      ...
      myRememberPasswordsCheckBox = new JCheckBox();
      myRememberPasswordsCheckBox.setMargin(new Insets(20, 3, 2, 3));
      myRememberPasswordsCheckBox.setText("Remember passwords for this session");
      myRememberPasswordsCheckBox.setMnemonic('R');
      myRememberPasswordsCheckBox.setDisplayedMnemonicIndex(0);
      myMainPanel.add(myRememberPasswordsCheckBox, BorderLayout.SOUTH);
    }
